#!/usr/bin/env python3
"""
ab-pay-hub/scripts/update-jobs.py
Daily job data updater — Alberta Pay Hub edition.
"""
...
def main():
    ...
    for raw_file in raw_files:
        with open(raw_file) as f:
            for line in f:
                ...
                job.setdefault("currency", "CAD")
                job.setdefault("region", "AB")
    ...
    db["meta"] = {
        ...
        "updated": TIMESTAMP,
        "state": "Alberta",
        "law": "⚖️ AB Employment Standards · Voluntary",
        "currency": "CAD",
        "region": "AB",
    }
